...
- **시장 체제별 기준 (윌리엄 오닐 전략 기반)**:
  - `parabolic`: 최소 점수 4, 손익비 floor 0.7, 최대 손절폭 -7%, 모멘텀 신호 1개+
  - `strong_bull`: 최소 점수 4, 손익비 floor 1.0, 최대 손절폭 -7%, 모멘텀 신호 1개+
  - `moderate_bull`: 최소 점수 4, 손익비 floor 1.2, 최대 손절폭 -7%, 모멘텀 신호 1개+
  - `sideways`: 최소 점수 5, 손익비 floor 1.3, 최대 손절폭 -6%, 모멘텀 신호 1개+
  - `moderate_bear`: 최소 점수 5, 손익비 floor 1.5, 최대 손절폭 -5%, 모멘텀 신호 2개+, 추가 확인 1개+
  - `strong_bear`: 최소 점수 6, 손익비 floor 1.8, 최대 손절폭 -5%, 모멘텀 신호 2개+, 추가 확인 1개+
...
- **핵심 원칙 (Core-1~4)**:
  - 종가 기준 룰(Closing-Price Rule): 손절가 및 trailing-stop 판단은 장중 변동을 배제하고 오직 종가만을 기준으로 함.
  - 마일스톤 해석: 매수 시나리오 목표가는 마일스톤일 뿐, 강세장에서는 추세 생존 시 보유를 지속하고 횡보/약세장에서만 즉시 전량 매도.
  - Trailing-stop 활성화: 최고가가 진입가 대비 +5% 이상 상승한 경우에만 활성화.
  - 매도 신호 계층화 (Tier 1~3):
    - `Tier 1`: 절대 매도 (종가 기준 손실률 ≥ -7%, 또는 종가가 손절가 이탈)
    - `Tier 2`: Trailing-stop 이탈 (강세장 고점 대비 -8~10%, 약세장 고점 대비 -3~5%)
